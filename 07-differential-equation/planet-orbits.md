...
$T-V=\frac{1}{2}\left( m\dot{r}^{2} +mr^{2}\dot{\theta }^{2}\right) +\frac{GMm}{r^{2}}$
...
$\frac{1}{r} =x=C_{3}\cos \theta +C_{4}\sin \theta +\frac{GM}{C_{1}^{2}} =C_{6}\cos( \theta +\theta _{0}) +\frac{GMm^{2}}{L^{2}}$
...
$\ddot{\mathbf{r}} =-\frac{GMm}{| \mathbf{r}| ^{3}}\mathbf{r}$

可见，至少在 $GM$ 这一项中，变化了 $r$ 的指数。所以，我们跳过推导过程，直接得到轨道微分方程
